...
$config['item']['discount']       = 'my-item-discount';    // Item discount, added by vinod
$config['item']['tax']        	  = 'my-item-tax';    // Item tax, added by vinod
$config['item']['comment']        = 'my-item-comment';    // Add comment, added by vinod
...
$config['text']['discounttotal']  = '';    // Discount
$config['text']['taxtotal']       = '';    // Tax
$config['text']['total']		  = '';
